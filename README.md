...
<style>
        ...
        body {
            ...
            background: url("supportassets/bg.png") center top repeat-x, url("bg2.png") left top repeat;
            background-size: 17.75rem 24.7rem, 1rem 1rem;
        }
        ...
        .icon {
            ...
            box-shadow: 0 2px 5px rgba(98, 98, 98, 0.4);
        }
